...
export const ENDINGS: Ending[] = [
  ...
  { id: 'forgotten_balanced', title: 'The Average', description: 'You played it safe your whole life. Nobody noticed when you were gone.', requirement: { legacyMin: 0, legacyMax: 999, dominantStat: 'balanced' } },
  ...
  { id: 'local_balanced', title: 'The Mayor', description: 'The community pillar. The solid citizen. Comfortable. Forgettable.', requirement: { legacyMin: 1000, legacyMax: 4999, dominantStat: 'balanced' } },
  ...
  { id: 'icon_balanced', title: 'The Titan', description: 'You had it all and played every angle. History books give you a paragraph.', requirement: { legacyMin: 5000, legacyMax: 9999, dominantStat: 'balanced' } },
  ...
  { id: 'immortal_balanced', title: 'The Legend', description: "You mastered everything. Bag, rep, power, soul. They'll be talking about you for a century.", requirement: { legacyMin: 10000, legacyMax: 999999, dominantStat: 'balanced' } },
];
