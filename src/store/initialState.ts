...
export const getInitialStats = (
  ...
  const baseStats: PlayerStats = {
    ...
    rivals: [
      { id: 'rival_mud', name: 'Salty Dog', netWorth: 5000, currentBid: 0, isNpc: true, tier: 'MUD', vengeance: 1, clout: Math.floor(50 + Math.random() * 150) },
      { id: 'rival_street', name: 'Flex Hamilton', netWorth: 50000, currentBid: 0, isNpc: true, tier: 'STREET', vengeance: 1, clout: Math.floor(50 + Math.random() * 150) },
      { id: 'rival_startup', name: 'Chadwick VC', netWorth: 500000, currentBid: 0, isNpc: true, tier: 'STARTUP', vengeance: 1, clout: Math.floor(50 + Math.random() * 150) },
      { id: 'rival_corp', name: 'Bezos Billions', netWorth: 5000000, currentBid: 0, isNpc: true, tier: 'CORPORATE', vengeance: 1, clout: Math.floor(50 + Math.random() * 150) },
      { id: 'rival_1', name: 'Sterling Vane', netWorth: 50000000, currentBid: 0, isNpc: true, tier: 'ELITE', vengeance: 1, clout: Math.floor(50 + Math.random() * 150) },
      { id: 'rival_2', name: 'Morgan Thorne', netWorth: 75000000, currentBid: 0, isNpc: true, tier: 'MOGUL', vengeance: 1, clout: Math.floor(50 + Math.random() * 150) },
      { id: 'rival_3', name: 'Elena Rosso', netWorth: 120000000, currentBid: 0, isNpc: true, tier: 'PRESIDENT', vengeance: 1, clout: Math.floor(50 + Math.random() * 150) },
      { id: 'rival_4', name: 'Victor Draken', netWorth: 250000000, currentBid: 0, isNpc: true, tier: 'OPEN', vengeance: 1, clout: Math.floor(50 + Math.random() * 150) },
    ],
    rivalThreats: {},
    activeChallenges: [],
