      ...
      {activeMode === 'CHOICE' && (
        <>
          <div className="text-center">
            <h2 className="text-xs font-black uppercase tracking-widest text-emerald-400">RECOVERY DECK</h2>
            <p className="text-[10px] text-slate-400 mt-0.5">Select a protocol. Failures still guarantee 100% baseline recovery values.</p>
          </div>
